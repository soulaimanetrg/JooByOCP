...
Route::post('/upload-cv', [JobsController::class, 'uploadCV'])->name('uploadCV'); // New route added for uploading CVs
...
Route::group(['prefix' => 'account'], function () {
    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::get('/create-job', [AccountController::class, 'createJob'])->name('account.createJob')->middleware(CheckAdmin::class) ;
