                ...
                <form action="" method="post" id="editJobForm" name="editJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-1">Modifier les détails de l'emploi</h3>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="" class="mb-2">Type d'emploi<span class="req">*</span></label>
                                ...
                                <div class="col-md-6  mb-4">
                                    <label for="" class="mb-2">Vacance<span class="req">*</span></label>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Salaire</label>
                                    <input value="{{ $job->salary }}" type="text" placeholder="Salaire" id="salary" name="salary" class="form-control">
                                </div>

                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Emplacement<span class="req">*</span></label>
                                    <input value="{{ $job->location }}" type="text" placeholder="Emplacement" id="location" name="location" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="textarea" name="benefits" id="benefits" cols="5" rows="5" placeholder="Avantages">{{ $job->benefits }}</textarea>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Responsabilité</label>
                                <textarea class="textarea" name="responsibility" id="responsibility" cols="5" rows="5" placeholder="Responsabilité">{{ $job->responsibility }}</textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <label for="" class="mb-2">Mots-clés</label>
                                <input value="{{ $job->keywords }}" type="text" placeholder="Mots-clés" id="keywords" name="keywords" class="form-control">
                            </div>

                            <h3 class="fs-4 mb-1 mt-5 border-top pt-5">Détails de l'entreprise</h3>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Emplacement</label>
                                    <input value="{{ $job->company_location }}" type="text" placeholder="Emplacement" id="company_location" name="company_location" class="form-control">
                                </div>
                            </div>
