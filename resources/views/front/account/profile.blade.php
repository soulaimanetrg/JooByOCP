                    ...
                    <form action="" method="post" id="userForm" name="userForm">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name" placeholder="Entrez le nom" class="form-control" value="{{ $user->name }}">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Email*</label>
                                <input type="text" name="email" id="email"  placeholder="Entrez l'email" class="form-control" value="{{ $user->email }}">
                                <p></p>
                            </div>
                            <div class="mb-4">
                                <label for="" class="mb-2">Désignation</label>
                                <input type="text" name="designation" id="designation"  placeholder="Désignation" class="form-control" value="{{ $user->designation }}">
                            </div>
                            <div class="mb-4">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" placeholder="Confirmer le mot de passe" class="form-control">
                        </div>                        
                    </div>
                    <div class="card-footer p-4">
                        <button type="submit" class="btn btn-primary">Mettre à jour</button>
